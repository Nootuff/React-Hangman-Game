...
class Hangman extends Component {
  ...
  */
  ...
  /*Determines whether or not the button keypad displays.*/
  buttonCheck() {
    let buttonsThere;
    if (this.state.nWrong >= this.props.maxWrong) { //If number of wrong guesses excedes maximum wrong answers allowed.
      buttonsThere = <p className='Hangman-msg'>"You lose! The answer was: <b>{this.state.answer}</b>"</p>
    } else {
      console.log(this.state.answer)
      console.log(this.guessedWord().join(""))
      if (this.guessedWord().join("") === this.state.answer) {
        buttonsThere = <p className='Hangman-msg'>Congratulations, you Win!</p>
      }
      else {
